...
class ObservationContract(BaseModel):
    ...
    def validate_observation_invariants(self) -> Self:
        ...
        if (
            ...
            and self.observation_status is not ObservationStatus.OBSERVED
        ):
            raise ValueError(
                "Partial/error/conflict observations cannot be current-confirmed"
            )
        ...
        if (
            ...
            raise ValueError("Conflict status requires conflict freshness")
