...
class ObservationSourceSpec:
    ...
    freshness_expectation_seconds: int
    ...
    for spec in source_specs:
        ...
        if policy is None:
            policy = CommandRefreshPolicyModel(
                ...
                freshness_expectation_seconds=spec.freshness_expectation_seconds,
            ...
            policy.freshness_expectation_seconds = spec.freshness_expectation_seconds
