...
class Experience:
    ...
    def content_hash(self) -> str:
        material = "|".join((self.experience_id, self.category, self.problem, self.solution, self.outcome, self.status.value))
...
# Constitutional/runtime invariants represented by this prototype:
# LEARNING != AUTHORITY
# MEMORY_UPDATE != PARAMETER_UPDATE
# PARAMETRIC_CHANGE != CONSTITUTION_CHANGE
# UNVERIFIED_LEARNING != CANONICAL_LEARNING
# FAILED_EVOLUTION -> ROLLBACK
# The policy weights above are external retrieval parameters, not LLM weights.
